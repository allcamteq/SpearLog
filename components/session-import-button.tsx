...
export function SessionImportButton() {
  ...
  return (
    <div className="relative shrink-0">
      ...
      {result && (
        <div className="absolute right-0 top-full z-10 mt-2 w-72 rounded-lg border border-surface-border bg-surface p-3 text-xs shadow-md">
          {"error" in result ? (
